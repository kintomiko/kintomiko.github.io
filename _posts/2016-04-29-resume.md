...
Yuan dedicate to build serval new products in ACS which help build up ACS's ITIL based cloud service. Yuan also lead to build auditing function to meet PCI standard, which is a great mailstone in ACS. Besides, Yuan refine ACS's serval working procedure to improve product quality.
...
### Software Engineer
Yuan leads the development of ACS's Contracting, Pricing and Quoting system "EPACT", successfully go live in 6 months. 
